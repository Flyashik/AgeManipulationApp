            ...
            {!image ?
                ...
                <>
                    <View style={{height: '15%', backgroundColor: '#000', flexDirection: 'row'}}>
                        <TouchableOpacity onPress={()=>setImage(null)} style={{marginTop: 'auto', marginBottom: 15, marginLeft: 15}}>
                            <Ionicons name="close" size={40} color="white" />
                        </TouchableOpacity>
                        <TouchableOpacity onPress={()=> navigateToAging()} style={{marginTop: 'auto', marginBottom: 15, marginLeft: 'auto', marginRight: 15}}>
